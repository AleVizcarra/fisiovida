                ...
                <div className="terapeuta">
                  ...
                  <div className="terapeuta-texto">
                    ...
                    <div className="redes-sociales">
                      ...
                      <a className="link-rs bg-gris" href="#">
                        <svg width="24px" height="24px" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#0466c8"><path d="M12 16a4 4 0 100-8 4 4 0 000 8z" stroke="#0466c8" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M3 16V8a5 5 0 015-5h8a5 5 0 015 5v8a5 5 0 01-5 5H8a5 5 0 01-5-5z" stroke="#0466c8" strokeWidth="1.5"></path><path d="M17.5 6.51l.01-.011" stroke="#0466c8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                      </a>
                    </div>
                  </div>
                </div>
